...
int main(void) {
    ...
    if (request_method != NULL && strcmp(request_method, "POST") == 0) {
        ...
        const int content_length = content_length_str
                                       ? atoi(content_length_str)
                                       : 0;
        ...
        if (post_data) {
            ...
            if (boundary) {
                ...
                if (file) {
                    ...
                    char send_json[1024];
                    sprintf(send_json,
                            "{\"code\": 200,\"message\": \"success\",\"data\": {\"task\": NULL}}");
            ...
            char* error_token =
                "{\"code\":401,\"message\":\"Failed to find multipart boundary\",\"data\":null}";
        ...
        char* error_token =
            "{\"code\":401,\"message\":\"This script only handles POST requests.\",\"data\":null}";
